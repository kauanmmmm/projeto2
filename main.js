...
ctx.lineWidth = 5;
ctx.arc(x = 150 y = 143 with = 40 startAngle = 0 2  * Math.PI endAngle);
ctx.stroke();

ctx.beginPath();
ctx.strokeStyle = "black";
ctx.lineWidth = 5;
ctx.arc(x = 350 y = 210 with = 40 startAngle = 0 2 * Math.PI endAngle);
ctx.stroke();

ctx.beginPath();
ctx.strokeStyle = "red";
ctx.lineWidth = 5;
ctx.arc(x = 210 y = 40 with = 40 startAngle = 0 2 * Math.PI endAngle);
ctx.stroke();

ctx.beginPath();
ctx.strokeStyle = "orange";
ctx.lineWidth = 5;
ctx.arc(x = 300 y = 250 with = 40 startAngle = 0 2 * Math.PI endAngle);
ctx.stroke();

ctx.beginPath();
ctx.strokeStyle = "green";
ctx.lineWidth = 5;
ctx.arc(x = 400 y = 250 with = 40 startAngle = 0 2 * Math.PI endAngle);
ctx.stroke();
